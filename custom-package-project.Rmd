...
g1 <- ggplot(data=red_traits,aes(x=Mother,y=log(RDistancedMoved_cm))) + geom_boxplot() + 
  xlab("Mother") + ylab("log(Distance moved during routine swimming (cm))")
g2 <- ggplot(data=red_traits,aes(x=Mother,y=log(RMeanSpeed))) + geom_boxplot() + 
  xlab("Mother") + ylab("log(Mean speed during routine swimming)")
g3 <- ggplot(data=red_traits,aes(x=Mother,y=log(abs(RMeanAngSpd)))) + geom_boxplot()  + 
  xlab("Mother") + ylab("log(Mean angular speed during routine swimming)")
g4 <- ggplot(data=red_traits,aes(x=Mother,y=log(abs(RMeanMeander)))) + geom_boxplot() + 
  xlab("Mother") + ylab("log(Mean meandering during routine swimming)")
g5 <- ggplot(data=red_traits,aes(x=Mother,y=log(RMeanMobility))) + geom_boxplot()  + 
